...
// Assignments
router.post('/:courseOfferingId/assignments', authenticate, authorizeRoles('faculty'), ctrl.createAssignment);
router.get('/:courseOfferingId/assignments', authenticate, authorizeRoles('faculty'), ctrl.getAssignments);
router.put('/assignments/:assignmentId', authenticate, authorizeRoles('faculty'), ctrl.updateAssignment);
